                    ...
                    <div class="shop-sidebar-area">
                        ...
                        <div class="sidebar-banner-widget mb-40" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">
                            <div class="banner-widget-content">
                                <div class="banner-shape"><img src="{{asset('images/widget/banner-shape-1.png')}}" alt="shape"></div>
                                <div class="banner-img"><img src="{{asset('images/widget/banner-1.png')}}" alt="image"></div>
                                <div class="content">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                ...
                                <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="30" data-aos-duration="600">
                                    <div class="product-thumbnail">
                                        ...
                                        <div class="hover-content">
                                            <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                            <a href="{{asset('images/products/product-1.png')}}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                        </div>
                                        <div class="cart-button">
                                            <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                        </div>
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                ...
                                <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="35" data-aos-duration="800">
                                    <div class="product-thumbnail">
                                        ...
                                        <div class="hover-content">
                                            <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                            <a href="{{asset('images/products/product-5.png')}}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                        </div>
                                        <div class="cart-button">
                                            <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                        </div>

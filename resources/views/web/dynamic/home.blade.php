...
@section('content')
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="hero-content style-one mb-50">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <img src="{{asset('images/hero/line-1.png')}}" alt="">
                                        </li>
                                        <li>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="hero-image-box">
                                    <div class="hero-image">
                                        <img src="{{asset('images/hero/hero-one_img1.jpg')}}" alt="Hero Image">
                                        <div class="hero-shape bg_cover" style="background-image: url({{asset('images/hero/hero-one-shape1.png')}});"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="banner-item style-one bg-one mb-40" data-aos="fade-up" data-aos-delay="10" data-aos-duration="900">
                        <div class="shape shape-one"><span><img src="{{asset('images/banner/discount.png')}}" alt="shape"></span></div>
                        <div class="shape shape-two"><span><img src="{{asset('images/banner/line.png')}}" alt="shape"></span></div>
                        <div class="banner-img"><img src="{{asset('images/banner/banner-1.png')}}" alt="banner image"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="banner-item style-one bg-two mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1100">
                        <div class="shape shape-one"><span><img src="{{asset('images/banner/discount.png')}}" alt="shape"></span></div>
                        <div class="shape shape-two"><span><img src="{{asset('images/banner/line.png')}}" alt="shape"></span></div>
                        <div class="banner-img"><img src="{{asset('images/banner/banner-2.png')}}" alt="banner image"></div>
                        <div class="banner-content">
                        ...
                        <div class="tab-pane fade show active" id="cat1">
                            <div class="row justify-content-center">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('images/products/feature-product-1.png')}}" alt="Products">
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('images/products/feature-product-3.png')}}" alt="Products">
                                            <div class="discount">10% Off</div>
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{asset('images/products/feature-product-2.png')}}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('images/products/feature-product-4.png')}}" alt="Products">
                                            <div class="discount">40% Off</div>
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{asset('images/products/feature-product-2.png')}}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{asset('images/products/feature-product-2.png')}}g" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                            </div>
                                            <div class="cart-button">
                                                <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{asset('images/products/feature-product-4.png')}}" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                            </div>
                                            <div class="cart-button">
                                                <a href="#" class="cart-btn"><i class="far fa-shopping-basket"></i> <span class="text">Add To Cart</span></a>
                                            </div>
        ...
        <div class="container-fluid">
            <div class="trending-products-slider" data-aos="fade-up" data-aos-duration="1400">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{asset('images/products/trending-product-1.png')}}" alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating5">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{asset('images/products/trending-product-2.png')}}" alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating5">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{asset('images/products/trending-product-3.png')}}" alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating5">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{asset('images/products/trending-product-4.png')}}" alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating5">
                ...
                <div class="product-item style-two">
                    <div class="product-thumbnail">
                        <img src="{{asset('images/products/trending-product-5.png')}}" alt="Products">
                    </div>
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating5">
    ...
    <section class="best-deal-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="offer-deal-wrapper bg_cover" data-aos="fade-up" data-aos-duration="1400" style="background-image: url({{asset('images/bg/deal-bg-1.png')}});">
                        <div class="deal-img">
                            <span><img src="{{asset('images/banner/deal-1.png')}}" alt="Image"></span>
                        </div>
    ...
    <section class="testimonial-section">
        <div class="testimonial-wrapper overflow-x-hidden pt-190 pb-90 white-bg">
            <div class="shape svg-shape1"><img src="{{asset('images/testimonial/tl-svgTop.svg')}}" alt="svg shape"></div>
            <div class="shape svg-shape2"><img src="{{asset('images/testimonial/tl-svgBottom.svg')}}" alt="svg shape"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <!--=== Section Content Box ===-->
                                    ...
                                    <div class="author-quote-item d-flex justify-content-between align-items-center">
                                        <div class="author-item">
                                            <div class="author-thumb">
                                                <img src="{{asset('images/testimonial/author-1.png')}}" alt="author image">
                                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="blog-post-item style-one mb-25" data-aos="fade-up" data-aos-duration="1200">
                        <div class="post-thumbnail">
                            <img src="{{asset('images/blog/blog-big-1.png')}}" alt="Post Thumbnail">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1400">
                                <div class="post-thumbnail">
                                    <img src="{{asset('images/blog/blog-sm-1.png')}}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1600">
                                <div class="post-thumbnail">
                                    <img src="{{asset('images/blog/blog-sm-2.png')}}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1800">
                                <div class="post-thumbnail">
                                    <img src="{{asset('images/blog/blog-sm-3.png')}}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-sm-6">
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="2000">
                                <div class="post-thumbnail">
                                    <img src="{{asset('images/blog/blog-sm-4.png')}}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
